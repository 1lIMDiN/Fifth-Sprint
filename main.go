...
func (t Training) distance() float64 {
	...
	totalDistance := float64(t.Action) * t.LenStep / MInKm
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	walkCalories := ((CaloriesWeightMultiplier * w.Weight + (math.Pow(w.meanSpeed(), 2) * KmHInMsec / w.Height / CmInM) *CaloriesSpeedHeightMultiplier * w.Weight) * w.Duration.Hours() * MinInHours)
	return walkCalories
}
